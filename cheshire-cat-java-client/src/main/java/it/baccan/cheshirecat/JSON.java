...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new it.baccan.cheshirecat.model.ValidationErrorLocInner.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new it.baccan.cheshirecat.model.Value.CustomTypeAdapterFactory());
