...
@JsonPropertyOrder({
  ...
  CatMessage.JSON_PROPERTY_MESSAGE,
...
public class CatMessage {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userId, catMessage.userId) &&
        ...
        Objects.equals(this.message, catMessage.message) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(userId, when, who, text, image, audio, type, why, message, content, additionalProperties);
  }
