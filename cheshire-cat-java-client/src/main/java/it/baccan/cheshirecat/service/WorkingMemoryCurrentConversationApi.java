...
public class WorkingMemoryCurrentConversationApi {
  private ApiClient apiClient;

  public WorkingMemoryCurrentConversationApi() {
    this(Configuration.getDefaultApiClient());
  }

  public WorkingMemoryCurrentConversationApi(ApiClient apiClient) {
  ...
  public ApiResponse<Object> getConversationHistoryWithHttpInfo() throws ApiException {
    ...
    return apiClient.invokeAPI("WorkingMemoryCurrentConversationApi.getConversationHistory", "/memory/conversation_history", "GET", new ArrayList<>(), null,
  ...
  public ApiResponse<Object> wipeConversationHistoryWithHttpInfo() throws ApiException {
    ...
    String localVarContentType = apiClient.selectHeaderContentType();
    GenericType<Object> localVarReturnType = new GenericType<Object>() {};
    return apiClient.invokeAPI("WorkingMemoryCurrentConversationApi.wipeConversationHistory", "/memory/conversation_history", "DELETE", new ArrayList<>(), null,
                               new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept, localVarContentType,
                               null, localVarReturnType, false);
  }
}
