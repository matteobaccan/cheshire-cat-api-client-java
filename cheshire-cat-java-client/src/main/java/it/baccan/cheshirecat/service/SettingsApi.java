...
public class SettingsApi {
     ...
     */
    public Setting createSetting(SettingBody settingBody) throws ApiException {
        ApiResponse<Setting> localVarResp = createSettingWithHttpInfo(settingBody);
     ...
     */
    public ApiResponse<Setting> createSettingWithHttpInfo(SettingBody settingBody) throws ApiException {
     ...
     */
    public okhttp3.Call createSettingAsync(SettingBody settingBody, final ApiCallback<Setting> _callback) throws ApiException {
     ...
     */
    public Setting getSetting(String settingId) throws ApiException {
        ApiResponse<Setting> localVarResp = getSettingWithHttpInfo(settingId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Setting> getSettingWithHttpInfo(String settingId) throws ApiException {
     ...
     */
    public okhttp3.Call getSettingAsync(String settingId, final ApiCallback<Setting> _callback) throws ApiException {
     ...
     * @param search The setting to search (optional, default to )
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public SettingsResponse getSettings(String search) throws ApiException {
        ApiResponse<SettingsResponse> localVarResp = getSettingsWithHttpInfo(search);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SettingsResponse> getSettingsWithHttpInfo(String search) throws ApiException {
     ...
     */
    public okhttp3.Call getSettingsAsync(String search, final ApiCallback<SettingsResponse> _callback) throws ApiException {
     ...
     */
    public Setting updateSetting(String settingId, SettingBody settingBody) throws ApiException {
        ApiResponse<Setting> localVarResp = updateSettingWithHttpInfo(settingId, settingBody);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Setting> updateSettingWithHttpInfo(String settingId, SettingBody settingBody) throws ApiException {
     ...
     */
    public okhttp3.Call updateSettingAsync(String settingId, SettingBody settingBody, final ApiCallback<Setting> _callback) throws ApiException {
