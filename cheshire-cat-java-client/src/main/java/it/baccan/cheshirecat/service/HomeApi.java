...
public class HomeApi {
  ...
  public ApiResponse<CatMessage> messageWithCatWithHttpInfo(Object body) throws ApiException {
    ...
    return apiClient.invokeAPI("HomeApi.messageWithCat", "/message", "POST", new ArrayList<>(), body,
  ...
  public Object status() throws ApiException {
    return statusWithHttpInfo().getData();
  }
  ...
  public ApiResponse<Object> statusWithHttpInfo() throws ApiException {
    ...
    return apiClient.invokeAPI("HomeApi.status", "/", "GET", new ArrayList<>(), null,
                               new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept, localVarContentType,
                               null, localVarReturnType, false);
  }
}
